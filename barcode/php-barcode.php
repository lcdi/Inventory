...
function addserial($code) {
	...
	global $con;
	$query = "INSERT INTO barcodes (`serials`) VALUES('$code')";
	if (!mysqli_query($con, $query)) {
		die('ERROR: ' . mysqli_error($con));
	} else {
		echo "<script>document.alert('worked');</script>";
	}
